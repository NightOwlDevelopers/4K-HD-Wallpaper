...
public class Video {
    ...
    public Video(@NonNull String img_id, String img_parent_id, String img_type, String img_path, String img_width, String img_height, String img_desc, String image_path_thumb, String size) {
        this.img_id = img_id;
