...
public class BannerLayoutManager extends RecyclerView.LayoutManager {
    ...
    protected float mInterval; //the mInterval of each item_latest_adapter's mOffset
    ...
    /**
     * max visible item_latest_adapter count
     */
    ...
    /**
     * @return the mInterval of each item_latest_adapter's mOffset
     */
    /**
     * @return the mInterval of each item_latest_adapter's mOffset
     */
    ...
    /**
     * Returns the max visible item_latest_adapter count, {@link #DETERMINE_BY_MAX_AND_MIN} means it haven't been set now
     * And it will use {@link #maxRemoveOffset()} and {@link #minRemoveOffset()} to handle the range
     *
     * @return Max visible item_latest_adapter count
     */
    ...
    /**
     * Set the max visible item_latest_adapter count, {@link #DETERMINE_BY_MAX_AND_MIN} means it haven't been set now
     * And it will use {@link #maxRemoveOffset()} and {@link #minRemoveOffset()} to handle the range
     *
     * @param mMaxVisibleItemCount Max visible item_latest_adapter count
     */
    ...
    /**
     * Used to reverse item_latest_adapter traversal and layout order.
     * This behaves similar to the layout change for RTL views. When set to true, first item_latest_adapter is
     * laid out at the end of the UI, second item_latest_adapter is laid out before it etc.
     * <p>
