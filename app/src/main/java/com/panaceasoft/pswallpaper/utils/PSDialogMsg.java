...
//            dialog.setCancelable(cancelable);
    ...
    public void showRatingDialog(String message, String okTitle, String cancelTitle, float oldRating)
    {
        ...
        msgTextView = dialog.findViewById(R.id.dialogMessageTextView);
        okButton = dialog.findViewById(R.id.dialogOkButton);
        ratingBar = dialog.findViewById(R.id.ratingBarFromDialog);

        titleTextView.setText(dialog.getContext().getString(R.string.user_rating));
        msgTextView.setText(message);
        okButton.setText(okTitle);
        cancelButton.setText(cancelTitle);
        ...
        if(!attached)
        {
            ...
            ratingBar.setOnRatingBarChangeListener((ratingBar, rating, fromUser) -> newRating = rating);
        ...
        if (dialog.getWindow() != null) {
            ...
            dialog.setCancelable(cancelable);
            okButton.setOnClickListener(view -> PSDialogMsg.this.cancel());
            cancelButton.setOnClickListener(v -> PSDialogMsg.this.cancel());
        }
    }

    public void showWallpaperSetConfirmDialog(String okTitle, String cancelTitle) {
        this.dialog.setContentView(R.layout.dialog_message);
        view = dialog.findViewById(R.id.dialogTitleView);
        titleTextView = dialog.findViewById(R.id.dialogTitleTextView);
        imageView = dialog.findViewById(R.id.dialogIconImageView);
...
//    public enum Type{
//        MESSAGE, HEADER_MESSAGE, CONFIRM, INFO, WARNING, SUCCESS, ERROR, CATEGORY_CONFIRM
//    }
}
